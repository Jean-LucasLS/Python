...
if len(char1) > len(char2):
    print(f'{char1} possui {len(char1)} caracteres, mais caracteres que {char2} que possui {len(char2)}.')
elif len(char1) < len(char2): 
    print(f'{char2} possui {len(char2)} caracteres, mais caracteres que {char1} que possui {len(char1)}.')
else:
